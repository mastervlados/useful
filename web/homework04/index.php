...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      <?php
      $job = [
      'job_name' => ['GeekBrains', 'Бэттери Тим', 'Студия Лебедева'],
      'job_data' => ['2022-present', '2000-2006', '1999-2000'],
      'job_desc' => ['Study at Frontend-programmer cources', 'Разная работа', 'Очень много креативной работы']
      ]
      ?>
